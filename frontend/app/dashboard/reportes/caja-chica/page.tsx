...
export default function ReporteCajaChicaAdminPage() {
  ...
  const queryString = useMemo(() => {
    ...
    if (usuarioId) params.set("cajera_id", usuarioId);
    return params.toString();
  }, [range.from, range.to, sucursalId, usuarioId]);
  ...
  async function descargarExcel() {
    ...
    a.href = downloadUrl;
    const fileName = `reporte-caja-chica_${scope}_${range.from}_a_${addDaysISO(
      range.to,
      -1
    )}.xlsx`;
    a.download = fileName;
    ...
    <div className="min-h-screen bg-[#2b0a0b] text-[#f8f1e6] flex">
      ...
      <div className="flex-1 flex flex-col">
        <header className="border-b border-[#5a1b22] bg-[#2b0a0b]/80 backdrop-blur flex items-center justify-between px-4 md:px-8 py-4 sticky top-0 z-10">
          <div>
            <h1 className="text-xl md:text-2xl font-semibold">Reportes de caja chica</h1>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="rounded-2xl border border-[#5a1b22] bg-[#3a0d12]/80 p-5 md:p-6">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <h2 className="text-2xl font-semibold">Reporte de caja chica</h2>
                  <p className="text-sm text-[#c9b296]">
                    Dia / Semana / Mes / Ano + filtros por cajera y sucursal.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <section className="space-y-4">
                ...
                <div className="rounded-2xl border border-[#5a1b22] bg-[#3a0d12]/80 p-4">
                  <p className="text-sm text-[#c9b296]">
                    El Excel trae: resumen + entregas + cambios, con autorizacion.
                  </p>
                </div>
              </section>
            </div>
